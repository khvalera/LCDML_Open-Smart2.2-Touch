...
void lcdml_menu_display() {
    ...
    do {
      ...
      if (tmp->checkCondition()) {
        ...
        if (tmp->checkType_menu() == true) {
          ...
          display.setCursor(12, _LCDML_FONT_H * (n));
  ...
  btn_down.initButton(&display, 25, 150, 50, 20, WHITE, CYAN, BLACK, "Down", 2);
  btn_up.initButton(&display, 76, 150, 50, 20, WHITE, CYAN, BLACK, "Up", 2);
  btn_enter.initButton(&display, 135, 150, 66, 20, WHITE, CYAN, BLACK, "Enter", 2);
  btn_quit.initButton(&display, 194, 150, 50, 20, WHITE, CYAN, BLACK, "Quit", 2);

  btn_down.drawButton(false);
  btn_up.drawButton(false);
  btn_enter.drawButton(false);
  btn_quit.drawButton(false);
