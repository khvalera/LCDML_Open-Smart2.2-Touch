// ============================================================
// Example:     LCDML: use display Open-Smart 2.2 Touch chip RM68130 
// ============================================================
// Author:      Jomelo, Markus Rudel, khvalera
...
#define _LCDML_TEXT_COLOR YELLOW
#define _LCDML_BACKGROUND_COLOR BLACK

#define _LCDML_FONT_SIZE 2
#define _LCDML_FONT_W (6 * _LCDML_FONT_SIZE)  // font width
#define _LCDML_FONT_H (10 * _LCDML_FONT_SIZE)  // font heigt
// cursor settings
#define _LCDML_DISP_CURSOR_CHAR ">"     // cursor char

// settings for u8g lib and lcd
#define _LCDML_lcd_w display.width()   // lcd width
#define _LCDML_lcd_h display.height()  // lcd height
...
// scrollbar width
#define _LCDML_scrollbar_w 10  // scrollbar width
...
void setup() {
  ...
  LCDML.SCREEN_enable(mFunc_screensaver, 30000);  // set to 30 seconds
